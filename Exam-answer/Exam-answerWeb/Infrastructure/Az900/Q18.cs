    ...
    public partial class Az900
    {
        public static QuestionEntity Q18Instance = new QuestionEntity()
        {
            ...
            Contents = new List<ContentEntity>()
            {
                ...
                new ContentEntity()
                {
                    Text = "The company’s support policy states that the Azure environment must provide an option to access support engineers by phone or email. You need to recommend which support plan meets the support policy requirement."
                },
                 new ContentEntity()
                {
                    Text = "Solution: Recommend a Standard support plan."
                },
                 new ContentEntity()
                {
