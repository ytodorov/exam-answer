    ...
    public partial class Az900
    {
        public static QuestionEntity Q82Instance = new QuestionEntity()
        {
            ...
            Contents = new List<ContentEntity>()
            {
                new ContentEntity()
                {
                    Text = "You have an Azure subscription that contains a virtual machine named VM1. VM1 hosts a line-of-business application that is available 24 hours a day. VM1 has one.",
                },
                new ContentEntity()
                {
                    Text = "Network interface and one managed disk. VM1 uses the D4s v3 size.",
                },
                new ContentEntity()
                {
