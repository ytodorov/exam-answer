    ...
    public partial class Az900
    {
        public static QuestionEntity Q80Instance = new QuestionEntity()
        {
            ...
            Contents = new List<ContentEntity>()
            {
                new ContentEntity()
                {
                    Text = "Contoso, Ltd. is a manufacturing company that has offices worldwide. Contoso works with partner organizations to bring products to market.",
                },
                new ContentEntity()
                {
                    Text = "Contoso products are manufactured by using blueprint files that the company authors and maintains.",
                },
                new ContentEntity()
                {
                ...
                new ContentEntity()
                {
                    Text = "Your network contains an Active Directory forest named contoso.com. All servers and client computers are joined to Active Directory.",
                },
                new ContentEntity()
                {
                    Text = "You have a public-facing application named App1. App1 is comprised of the following three tiers:.",
                },
                new ContentEntity()
                {
                    Text = "A SQL database.",
            ...
            Explanations = new List<ExplanationEntity>()
            {
                ...
                {
                    Text = "A Recovery Services vault is a logical container that stores the backup data for each protected resource, such as Azure VMs. When the backup job for a protected"
                },
                new ExplanationEntity()
                {
                    Text = "resource runs, it creates a recovery point inside the Recovery Services vault."
                },
                new ExplanationEntity()
                {
                    Text = "Scenario:"
